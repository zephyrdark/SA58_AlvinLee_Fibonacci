...
3. Run the Spring Boot application. It will be available at `http://localhost:8080/api/coin-request`, but it is recommended to use Postman as described in [Usage Section](https://github.com/zephyrdark/SA58_AlvinLee_Fibonacci/edit/main/README.md#2-various-usages).
...
2. Start your application by running:
   ...
   ```
3. It will be available at `http://localhost:8080/api/coin-request`, but it is recommended to use Postman as described in [Usage Section](https://github.com/zephyrdark/SA58_AlvinLee_Fibonacci/edit/main/README.md#2-various-usages).
